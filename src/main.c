...
static void menu_select_callback(int index, void *ctx) {
  ...
  if (s_special_flag) {
    menu_item->subtitle = "Very conventional..";
  }  else {
    menu_item->subtitle = "Are You Sure?";
  }
  
  if (++s_hit_count ==3) {
    menu_item->subtitle = "you managed to hit it 3x";
  }
  ...
  //s_first_menu_items[index].subtitle = "That is very conventional..";
